  ...
  extends TableSourceBuilder
{
  ...
  private void readTableOptions(TableIdentifier tbl)
  {
    ...
    catch (SQLException e)
    {
      ...
      LogMgr.logMetadataError(new CallerInfo(){}, e, "table options", sql, tbl.getSchema(), tbl.getTableName());
    }
    finally
    {
  ...
  public void readForeignTableOptions(TableIdentifier table)
  {
    ...
    try
    {
      ...
      LogMgr.logMetadataSql(new CallerInfo(){}, "table options", sql, table.getSchema(), table.getTableName());
